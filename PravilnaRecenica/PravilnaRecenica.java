...
class SLL<E> {
    ...
    {
       //  if((Character)current.succ.element=='.' || (Character)current.succ.element==' ')
        SLLNode<E> curr = first;
        SLLNode<E> begin = first;
        SLLNode<E> end = curr;

        while(curr.succ!=null){

            if((Character)curr.succ.element=='.' || (Character)curr.succ.element==' '){

                end = curr;
                this.insertBefore(end.element, begin);
                end = end.succ.succ;
                delete(curr);
            }
            curr = curr.succ;
...
public class PravilnaRecenica {
    ...
    public static void main(String []args) throws IOException
    {
        ...
        char[] bukvi=recenica.toCharArray();
